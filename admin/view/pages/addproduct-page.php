...
if (isset($_POST['addproductbtn']) && $_POST['addproductbtn']) {
    ...
    $is_inserted = insert_product($cateid, $proname, $oldprice, $newprice, $shortdesc, $fulldesc, $new, $view, $sale, $target_file1, $target_file2, $target_file3, $target_file4, $target_file5);
    if ($is_inserted) {
        echo '<div class="add-product-success d-none" style="">HELLO</div>';
    }
