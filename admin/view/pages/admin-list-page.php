<div class="p-2">
    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-4 my-2 my-md-0 mw-100 navbar-search ">
        <div class="input-group">
            <input type="text" class="form-control bg-light border border-primary small " placeholder="Tìm kiếm Admin"
                aria-label="Search" aria-describedby="basic-addon2">
            <div class="input-group-append">
                <button class="btn btn-primary" name="searchadmin" type="submit" />
...
foreach ($admin_list as $admin) {
    echo '
            ...
            <td><a href="index.php?act=deleteadmin&id=' . $admin['id'] . '" class="btn-danger p-2">Xóa</a></td>
        </tr>
            ';
}
?>
