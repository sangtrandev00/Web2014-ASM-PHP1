...
if (isset($_POST['updateproductbtn']) && $_POST['updateproductbtn']) {
    ...
    $is_updated = update_product($id, $cateid, $proname, $oldprice, $newprice, $shortdesc, $fulldesc, $new, $view, $sale, $target_file1, $target_file2, $target_file3, $target_file4, $target_file5);

    if ($is_updated) {
        echo '<div class="edit-product-success d-none" style="">HELLO</div>';
    }
} else {
