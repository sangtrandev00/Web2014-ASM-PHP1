                               ...
                               <div class="mb-3 row form-group">
                                   ...
                                   <div class="col-sm-10">
                                       <input name="fullname" type="text" class="form-control"
                                           value="<?php echo $user['name'] ?>" id="inputName">
                                   </div>
                               </div>
                               <div class="mb-3 row form-group">
                               ...
                               <div class="mb-3 row form-group">
                                   ...
                                   <div class="col-sm-10">
                                       <input type="text" name="homeaddress" class="form-control"
                                           value="<?php echo $user['address'] ?>" id="inputAddress">
                                   </div>
                               </div>
...
if (isset($_POST['updateinfobtn']) && $_POST['updateinfobtn']) {
    ...
    $is_updated = updateuser($iduser, $target_file, $name, $email, $phonenumber, $address);
    if ($_is_updated) {
        echo '<div class="update-userinfo-success d-none" style="">HELLO</div>';
    }
...
if (isset($_POST['changepassbtn']) && $_POST['changepassbtn']) {
    ...
    if ($isRightPass == -1) {
        ...
        echo '<div class="update-pass-user-fail--wrong-pass d-none" style="">HELLO</div>';
        ...
        if ($newpassword == $reenterpass) {
            ...
            echo '<div class="update-pass-user-fail--wrong-repass d-none" style="">HELLO</div>';
