...
<div class="modal success-modal fade " id="exampleModal2" aria-labelledby="exampleModal2Label" aria-hidden="true"
    tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content ">
            <div class="modal-header ">
                <h5 class="modal-title text-white">Cập nhật danh mục thành công</h5>
...
<button type="button" class="launch-modal-btn btn btn-primary d-none" data-toggle="modal" data-target="#exampleModal2">
    Launch demo modal
</button>
